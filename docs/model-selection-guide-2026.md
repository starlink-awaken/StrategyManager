...
### Domestic Models (Step & Qwen)

| 模型 | 性能 | 成本 | 适用场景 | 备注 |
|------|------|------|----------|------|
| **Qwen 3.5 Plus** | ⭐⭐⭐⭐⭐ | **极低** (¥0.0008/1K) | 高性能、低成本主力 | 397B MoE, 2026 最新旗舰 |
| **Step 3.5 Flash** | ⭐⭐⭐⭐ | 低 | 智能体、快速任务 | 针对 Agent 优化, 2026 最新 |
| **Qwen 3 (Open-weight)** | ⭐⭐⭐⭐ | 灵活 (支持私有化) | 私有部署、特定领域 | Qwen3-235B 性能强劲 |
| **Step 2** | ⭐⭐⭐⭐ | 中 | 复杂推理、多模态 | 阶跃星辰旗舰 MoE |

#### Qwen 3.5 Plus vs Step 3.5 Flash

```
性能对比:
  Qwen 3.5 Plus: 综合能力极强，接近 GPT-5.2，适合作为主力模型
  Step 3.5 Flash: 响应极快，Agentic 能力优化，适合作为子任务执行器

成本对比:
  Qwen 3.5 Plus: ¥0.8 / 百万 tokens (in/out)
  Step 3.5 Flash: 极具竞争力，OpenRouter 提供免费版

推荐场景:
  Qwen 3.5 Plus → 核心逻辑、复杂编码、长文本分析
  Step 3.5 Flash → 快速搜索、工具调用、简单重构
```
